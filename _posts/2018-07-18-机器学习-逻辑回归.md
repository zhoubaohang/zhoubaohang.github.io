...
**Example:** if $\begin{align}&x=\begin{bmatrix}x_0\\x_1\end{bmatrix}=\begin{bmatrix}1\\tumorSize\end{bmatrix}\\&h_\theta(x)=0.7 \end{align}$
...
![Alt text](\img\2018-07-13-logistic_regression.png)
